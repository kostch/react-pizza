    ...
    <>
      <div className="cart">
        <div className="cart__top">
          ...
          <div onClick={() => setOpenModal(true)} className="cart__clear">
        ...
        <div className="content__items container--cart">
          {
            items.map((item: any) => <CartItem key={`${item.id}_${item.type}_${item.size}`} {...item}/>)
          }
        </div>
